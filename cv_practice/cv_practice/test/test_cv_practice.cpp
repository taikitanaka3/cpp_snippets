...
TEST(test, fillpoly) {
  ...
  std::vector<cv::Point> cv_polygon={cv::Point(0,0),cv::Point(80,80),cv::Point(0,80)};
  cv_polygons.emplace_back(cv_polygon);
  cv_polygons.emplace_back(std::vector<cv::Point>{cv::Point(0,0),cv::Point(20,20),cv::Point(0,20)});
