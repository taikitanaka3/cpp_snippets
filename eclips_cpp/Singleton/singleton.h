...
#ifndef ECLIPS_CPP__SINGLETON__SINGLETON_H_
#define ECLIPS_CPP__SINGLETON__SINGLETON_H_
#include <iostream>
#include <string>

using namespace std;

template <class U> class SingletonParent {
public:
...
protected:
  ...
  SingletonParent() { base_str = string("BASE"); }
...
public:
  ...
  void print() { print2Times(child_value); }

public:
  int child_value = 10;
};

template <class U> class SingletonParentA {
public:
  static U &getInstance() {
    static U instance;
    return instance;
...
protected:
  ...
  SingletonParentA() { base_str = string("BASE"); }
...
#endif // ECLIPS_CPP__SINGLETON__SINGLETON_H_
